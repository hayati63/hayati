...
def main():
    ...
    print("\n  ⚠️ **این جدول را نخوانید.** ستون «هم‌کندل» نشان می‌دهد چرا:")
    print("  باکس هفتگی میانهٔ ۱٫۴۲٪ عرض دارد و دامنهٔ یک روزِ معاملاتی")
    print("  میانهٔ ۲٫۶۲٪ — یعنی باکس از یک کندل **باریک‌تر** است. ورود و")
    print("  استاپ در یک کندل می‌افتند و دادهٔ روزانه نمی‌داند اول کدام.")
    print("  «میانگین R» اینجا نتیجهٔ قاعده نیست، حدِ تفکیکِ داده است.")
    print("\n  بند ۳ CLAUDE.md همین قاعده را ۷۰٫۲٪ و +۰٫۴۰۹R ثبت کرده")
    print("  (n=۴۲۹، ۱۱ از ۱۲ نماد). آن n با ۱۲ نماد می‌خواند و پروفایلش")
    print("  H1 بوده — با H1 هر کندل حدود ۰٫۵٪ دامنه دارد، یعنی باریک‌تر از")
    print("  باکس، و آن‌جا ورود و استاپ **قابل تفکیک‌اند**. پس عدد آن‌ها با")
    print("  عدد اینجا در تضاد نیست؛ آن یکی قابل اندازه‌گیری بوده، این یکی نه.")
